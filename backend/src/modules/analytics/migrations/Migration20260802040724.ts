...
export class Migration20260802040724 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table if not exists "product_view" ("id" text not null, "product_id" text not null, "day" text not null, "views" integer not null default 0, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "product_view_pkey" primary key ("id"));`);
